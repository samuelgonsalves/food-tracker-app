module FoodInfoHelper
	...
	def calorie_chart_by_day
		line_chart FoodInfo.group_by_day(:created_at).sum(:calories), width:"300px", height:"400px",ytitle:"Calories", xtitle:"Food" 	
	end
	def carb_chart_by_day
		line_chart FoodInfo.group_by_day(:created_at).sum(:carb), width:"300px", height:"400px",ytitle:"Carbs (in grams)", xtitle:"Food" 	
	end
	def protein_chart_by_day
		line_chart FoodInfo.group_by_day(:created_at).sum(:protein), width:"300px", height:"400px",ytitle:"Protein (in grams)", xtitle:"Food" 	
	end
	def fat_chart_by_day
		line_chart FoodInfo.group_by_day(:created_at).sum(:fat), width:"300px", height:"400px",ytitle:"Fat (in grams)", xtitle:"Food" 	
	end
